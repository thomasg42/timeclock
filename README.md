...
- **Policies**: check one or many packs per event (General Handbook, PBR & Rodeo, VIP Policy). VIP is the lounge opening and closing lists — visible grab-and-go checklists. Opening an event shows summaries plus expandable full policy text (VIP lists stay open). Creating “Wildlands” (etc.) saves it as a reusable chip with those policies remembered.
